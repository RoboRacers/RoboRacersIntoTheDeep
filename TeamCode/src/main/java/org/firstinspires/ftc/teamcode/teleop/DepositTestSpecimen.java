...
@TeleOp(name ="DepositTestSpecimen", group = "16481-IntoTheDeep")
public class DepositTestSpecimen extends LinearOpMode {
...
//
                if (gamepad2.dpad_down){
                   ...
                   // pitch.setPosition(0);
                    flipRightDeposit.setPosition(0.02);
                    flipLeftDeposit.setPosition(0.02);
                }
