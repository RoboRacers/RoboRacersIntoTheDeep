...
@Config
public class AssemblyShrekster implements Subsystem {
    ...
    public static final double PITCH_MID_POSITION = -800;
    ...
    public AssemblyShrekster(HardwareMap hardwareMap) {
    ...
    public void setPitchTarget (double pitchTarget) {
        AssemblyShrekster.pitchTarget = pitchTarget;
    }

    public void setSlideTarget (int slideTarget) {
        AssemblyShrekster.slideTarget = slideTarget;
    }
...
//        double feedforward = pitchKf * Math.cos(Math.toRadians(pitchAngle));
    ...
    public Action extendSlide(int slideTarget) {
        return telemetryPacket -> {
            AssemblyShrekster.slideTarget = slideTarget;
            slidePosition = slidesMotor.getCurrentPosition();
            slidesPIDUpdate(AssemblyShrekster.slideTarget);
